        ...
        <div class="registered">
          ...
          <div class="content" style="margin-top: 20px;">
            <ul class="common-form">
              ...
              <li>
                <div class="input">
                  <input type="text" v-model="registered.phone" placeholder="输入手机号" />
                </div>
              </li>
              <!-- <li>
                <div id="captcha">
            ...
            <ul class="common-form pr">
              ...
              >
                <span>如果您已拥有 TBMall 账号，则可在此</span>
...
export default {
  ...
  methods: {
    ...
    regist () {
      ...
      if (!userName || !userPwd || !userPwd2 || !phone) {
        this.message('账号密码和手机号不能为空!')
        this.registxt = '注册'
        return false
      }
      if (userPwd2 !== userPwd) {
