        ...
        <div class="edit-avatar" v-if="editAvatarShow">
          <y-shelf title="设置头像">
            ...
            <div slot="content" class="content">
              ...
              <el-form :model="infoForm" ref="infoForm" label-width="80px" label-position="top" style="width:40%;">
                <el-form-item label="新密码">
                  <el-input v-model="infoForm.typeNewPassword" type="password" placeholder="输入新密码"></el-input>
                </el-form-item>
                <el-form-item label="新电话号码">
                  <el-input v-model="infoForm.typeNewPhoneNumber" placeholder="输入新电话号码"></el-input>
                  
                </el-form-item>
                
                <el-form-item>
                  <el-button type="primary" @click="onSubmit(infoForm.typeNewPassword,infoForm.typeNewPhoneNumber)">保存</el-button>
...
export default {
  ...
  methods: {
    ...
    onSubmit(typeNewPassword,typeNewPhoneNumber){
      let params = {
        typeID: this.userId,
        typeNewPassword,
        typeNewPhoneNumber
