    ...
    <div class="container">
      <div class="siteinfo">
        ...
        <ul class="c0">
          <h3 class="c1">服务支持</h3>
          <ul>
            <li class="c2"><a class="c3" target="_blank" >官方开源</a></li>
            <li class="c2"><a class="c3" target="_blank" >项目前端</a></li>
            <li class="c2"><a class="c3" target="_blank" >项目后端</a></li>
          </ul>
        </ul>
        <ul class="c0">
          <h3 class="c1">自助服务</h3>
          <ul>
            <li class="c2"><a class="c3" target="_blank" >个人博客</a></li>
            <li class="c2"><a class="c3" target="_blank" >个人简介</a></li>
            <li class="c2"><a class="c3" target="_blank" >个人视频</a></li>
          </ul>
        </ul>
        ...
        <ul class="c0">
          <h3 class="c1">媒体中心</h3>
          <ul>
            <li class="c2"><a class="c3" target="_blank" >新闻动态</a></li>
            <li class="c2"><a class="c3" target="_blank" >官方视频</a></li>
            <li class="c2"><a class="c3" target="_blank" >图片资源</a></li>
          </ul>
        </ul>
        <ul class="c0">
          <h3 class="c1">关注我们</h3>
          <ul>
            <li class="c2"><a class="c3" target="_blank" >荣誉奖项</a></li>
        ...
        <ul class="c4">
          <li class="tel"><a class="c5" target="_blank">400 - 626 - 5666</a></li>
      ...
      <div class="copyright">
        ...
        <ul class="privacy">
          ...
          <li class="content-c1"><a class="content-c0" target="_blank" href="https://github.com/">开发者中心</a></li>
        </ul>
      </div>
      <div class="cop">
  ...
  export default {
    ...
    methods: {
      open1 () {
        this.$notify.info({
          title: '法律声明',
          message: '此仅为小学期电商项目，仅供学习参考，承担不起任何法律问题'
        })
      },
      open2 () {
        this.$notify.info({
